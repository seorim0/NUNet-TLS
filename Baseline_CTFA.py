"""
Baseline model + Causal Time-Frequency Attention (CTFA)
"""
import torch
...
# Baseline network + causal time-frequency attention
class Baseline_CTFA(nn.Module):

    def __init__(self, in_ch=1, mid_ch=32, out_ch=64):
        super(Baseline_CTFA, self).__init__()
